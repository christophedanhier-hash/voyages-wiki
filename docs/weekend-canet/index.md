# 🇫🇷 Canet → La Jonquera → Castellfollit → Castelnou → Orgues → Peyriac → **Lyon** 🏛️ → Gerpinnes

> **🗓️ 19/06 → avant le 26/06 | 🚐 Zéro péage | Max 400 km/j | Pascal & Agnès**
...
| **🕐** | Supermarché 7h30→23h / Boutiques 9h→21h |
| **🅿️** | 1 500 places gratuites — CC compatible |
| **⛽** | Diesel ~1,58 €/L |

> ⚠️ Pièces d'identité obligatoires. Limites : 200 clopes / 1L alcool/pers.
...
| **🏰** | Perché sur une falaise de basalte de 50 m — **217 000 ans** ! |
| **🅿️ Nuit** | ✅ Parking gratuit + point d'eau |

---

### Jour 2 — Samedi 20/06 : Castellfollit → Castelnou 🏰 → Orgues 🏔️ → Peyriac 🧂

| Horaire | Activité |
|:-------:|----------|
| **09h00** | ☕ Petit-déjeuner à Castellfollit |
| **09h30 → 10h30** | 🚐 Route vers **Castelnou** (~70 km / 1h) |
| **10h30 → 12h00** | 🏰 **Visite Castelnou** — Plus Beau Village de France |
| **12h00 → 12h10** | 🚐 Route vers **les Orgues** (5 min !) |
| **12h10 → 13h00** | 🏔️ **Visite des Orgues d'Ille-sur-Têt** (5€) |
| **13h00 → 14h00** | 🥪 Déjeuner aux Orgues ou Castelnou |
| **14h00 → 15h00** | 🚐 Route vers **Peyriac-de-Mer** (~75 km / 1h) |
| **15h00 → 17h30** | 🧂 **Balade des Salins de Peyriac** — marais, flamants roses |
| **17h30** | 🚐 Installation aire CC |
| **Nuit** | 🌙 **Aire Peyriac-de-Mer** — 8 €, eau, vidange |

#### 🏰 Castelnou

> Fondé vers **990**, capitale du Vallespir pendant 300 ans. Château vicomtal, remparts à 8 tours. Classé **Plus Beau Village de France**. Gratuit / château 5€.

#### 🏔️ Les Orgues d'Ille-sur-Têt

> Cheminées de fée vieilles de **4 millions d'années** — classées monument naturel. 5€/pers, visite ~1h.

#### 🧂 Peyriac-de-Mer — Salins & Marais

| | |
|:---|---:|
| **📍 Aire CC** | 43.092381, 2.962919 — Route de Bages |
| **💰** | 8 € (service + stationnement) |
| **💧** | Eau, vidange, WC |
| **🚶** | Balade des salins : sentier des anciens marais salants, observation des oiseaux (flamants roses). Compter ~2h. |
...
| Horaire | Activité |
|:-------:|----------|
| **08h30** | ☕ Petit-déjeuner — dernière balade aux salins |
| **10h00** | 🚐 Départ de Peyriac |
| **→ N9** | Narbonne → Béziers → Montpellier |
| **→ N113** | Montpellier → Nîmes |
| **→ N7** | **La Nationale 7 !** Orange → Montélimar → Valence → Vienne |
| **Pause** | 🥪 Montélimar — nougat à emporter |
