...
> 🔄 Document basé sur le PDF « JAPON 2026 » de Christophe, adapté en roadbook pour 2028-2029.
...
| Métrique | Valeur |
|:---|:---:|
| **Tokens IN** | ~180 000 (estimation) |
| **Tokens OUT** | ~60 000 (estimation) |
...
| 🚇 Transports locaux (Tokyo, Kyoto, Osaka) | **Welcome Suica** | — | ~100 € (2 pers) | Carte IC rechargeable |
| 🏔️ Excursions (Nikko, Nara) | JR + bus | — | ~60 € (2 pers) | Billets individuels |
...
## 💰 Budget estimé (2 personnes, 17 jours)
...
| 🎢 **Universal Studios Japan** | Dès ouverture des ventes (~2 mois avant) | site officiel USJ | 🔴 |
| 🍄 **Nintendo World** (pass garanti) | En même temps que USJ | site officiel USJ | 🔴 |
| 🌸 **TeamLab** | 1-2 semaines avant (créneau horaire) | teamlab.art | 🟠 |
| 🗼 **Shibuya Sky** | 1-2 semaines avant | shibuyasky.jp | 🟠 |
| ⛩️ **Combat de sumo** (Ryogoku) | Dès mise en vente (tournoi mai) | sumo.or.jp | 🟠 |
| 🏨 **Hôtels Tokyo / Kyoto / Osaka** | 3-6 mois avant | Booking.com / sites locaux | 🟠 |
| 🏔️ **Ryokan Mizunosato** (Kawaguchiko) | 3-6 mois avant | Site du ryokan | 🔴 |
| 🚄 **Fuji Excursion** (Shinjuku→Kawaguchiko) | 1 mois avant (places limitées) | JR East / eki-net | 🟡 |
...
| 🏥 **Assurance voyage** | Carte européenne + complémentaire rapatriement |
...
### 🚶 Rythme & logistique
- **J4 et J16 (Nikko)** : garder les 2 créneaux possibles — un pour le beau temps, l'autre en réserve (météo).
- **Kyoto** : se lever tôt pour Fushimi Inari (7h) et Arashiyama (avant 8h) — éviter la foule.
- **Dimanche** : USJ + Nintendo World souvent bondés — si possible, choisir un **jour de semaine** pour J12.
- **Bagages** : prévoir un sac léger pour Kawaguchiko (J5-J6) — pas de porteur de valises sur la rando.
- **Japon cash-lite** : carte bancaire + Suica suffisent (mais quelques milliers de yens en liquide pour les petits temples/kiosques).

### 💡 Bonus si le budget le permet
- **Kobe** (journée depuis Osaka) : bœuf de Kobe + vue port — uniquement si grosse motivation (J13 optionnel).
- **Nishiki Market** (Kyoto) : déjeuner rapide avant le départ vers Osaka le J10.
...
*Roadbook généré par Sylvia — BAVI LEO Voyages. À affiner : année exacte (2028/2029), hôtels définitifs, prix vols réels au moment de la réservation.*
