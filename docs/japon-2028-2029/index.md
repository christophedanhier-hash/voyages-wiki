...
> 🔄 Roadbook adapté pour un couple de 60 ans avec **mobilité réduite (5-6 km/j)** : journées allégées, 3 journées de repos, onsen réguliers, randonnées supprimées.
...
| Aéroport | Distance | ~Temps route | Parking 21 j |
|:---|:---:|:---:|:---:|
...
|:---|:---|:---:|:---:|:---|
| 🚃 Tokyo → Hakone | **Romancecar** (Odakyu) | ~1h30 | ~50 € | Sièges réservés, confortable |
| 🚌 Hakone → Kawaguchiko | Bus direct | ~2h30 | ~40 € | Trajet panoramique |
| 🚌 Kawaguchiko → Mishima | Bus direct | ~2h | ~30 € | Pas de train direct |
| 🚄 Mishima → Kyoto | Shinkansen Hikari/Kodama | ~2h | ~180 € | Porte-à-porte ~4h30 |
| 🚄 Kyoto → Osaka | JR Special Rapid | ~30 min | ~20 € | Fréquent (10-15 min) |
| 🚄 Osaka → Tokyo | Shinkansen | 2h30-3h | ~180 € | Nozomi / Hikari |
| 🚇 Transports locaux (Tokyo, Kyoto, Osaka) | **Welcome Suica** | — | ~120 € (2 pers) | Carte IC rechargeable |
| 🏔️ Excursions (Nara, Nikko) | JR + bus | — | ~60 € (2 pers) | Billets individuels |

> ⚠️ **JR Pass ?** Pour ce trajet **aller simple** (pas d'aller-retour), le JR Pass 14 jours (~500 €/pers) n'est **probablement pas rentable**. Billets individuels ≈ 450 €/pers. Vérifier avec le **JR Pass Calculator** avant de décider.
...
**Organisation conseillée** : 5 nuits à **Ueno** (arrivée + acclimatation, JR Yamanote + Shinkansen + Skyliner aéroport) + 4 nuits finales à **Shinjuku** (pôle ouest, retour Odaiba/Nikko, montres Jackroad !).

| Hôtel | Quartier | Prix/nuit € | Note | Points forts | Point faible |
|:---|:---|:---:|:---:|:---|:---|
| ⭐ **Dormy Inn Ueno Okachimachi** | Ueno | 110-145 € | 8,5 | **Onsen sur le toit** (récupération !) • Ramen gratuit le soir • 2 min JR Okachimachi | Légèrement au-dessus du budget, chambres petites |
...
| **Sunroute Plaza Shinjuku** | Shinjuku | 95-125 € | 8,4 | 3 min sortie Sud Shinjuku • Calme malgré la gare • Anglophone | Déco datée |
| **Hotel Gracery Shinjuku** | Shinjuku | 110-150 € | 8,4 | Godzilla sur le toit 🦖 • Très bien situé • Chambres spacieuses | Kabukicho = vie nocturne agitée le soir |
| **APA Hotel Ueno Ekimae** | Ueno | 70-95 € | 7,9 | 1 min de la gare • Propre, fiable | Chambres très petites (14 m²) |

### ♨️ Hakone — 1 nuit (J6)

| Option | Type | Onsen | Prix/nuit 2 pers € | Points forts | Point faible |
|:---|:---|:---:|:---:|:---|:---|
| ⭐ **Ryokan avec onsen privé** (ex: Hakone Suimeisou / Yamano Chaya) | Ryokan | ✅ | 180-350 € (2 repas) | Expérience onsen authentique • Dîner kaiseki | Réserver tôt |
| **Hakone Kowakien Tenyu** | Hôtel ryokan-style | ✅ | 250-400 € | Grands bains + vue montagne | Haut de gamme |

> 💡 Hakone = LA station d'onsen du Japon — c'est LE soir détente du voyage. Choisir un ryokan avec **bain privé en chambre** si le budget le permet (plus simple pour la mobilité de Sylvie).

### 🗻 Kawaguchiko — 2 nuits (J7-8)

| Option | Type | Vue Fuji | Onsen | Prix/nuit 2 pers € | Points forts | Point faible |
|:---|:---|:---:|:---:|:---:|:---|:---|
| ⭐ **Lakeland Hotel Mizunosato** | Ryokan, rive nord | ✅ | ✅ | **~220-300 €** (2 repas) | **Meilleur rapport vue Fuji + onsen + kaiseki** • 5-10 min bus/taxi gare | Populaire — réserver tôt |
| **Ubuya** | Ryokan haut de gamme | ✅ 100 % | ✅ | 400-750 € (2 repas) | Vue Fuji la plus spectaculaire • Bain sur le toit | Prix très élevé, complet des mois avant |
| **Yamagishi** | Petit ryokan familial | ✅ | ✅ | ~190-320 € (2 repas) | Ambiance authentique • Prix doux | Installations modestes |

> 💡 Pour Sylvie : réserver **2 nuits** au même ryokan (pas de changement de bagages) — le J8 est une journée off complète avec vue Fuji + onsen.
...
| 💎 **Moku House** | Higashiyama (Kiyomizu) | 95-130 € | 8,8 | **Vraie machiya traditionnelle restaurée** • 5 min de Kiyomizu | Salles de bain partagées selon chambres |
| **Saka Hotel Kyoto** | Higashiyama (5 min Kiyomizu) | 130-180 € | 9,0 | 5 min à pied de Kiyomizu (visites tôt) • Bain public + sauna | Au-dessus du budget, chambres petites |

> 💡 **Kyoto** : privilégier un hôtel avec **onsen** (Celestine ou Onyado Nono) — après 5 jours de visite, le bain chaud du soir est précieux.

### 🐙 Osaka — 4 nuits (J14-17)
...
## 💰 Budget estimé (2 personnes, 21 jours)
...
| Boutique | Ville | Quartier | Type |
|:---|:---|:---|:---|
| **Jackroad** | Tokyo | Shinjuku | Vintage — grosse référence |
| **Seiko Dream Square** | Tokyo | Ginza | Neuf — flagship Seiko |
| **Mizutani Camera** | Tokyo | Ueno | Vintage |
| **BB Amemura** | Osaka | America-mura | Vintage |

> 💡 Prévoir **500-2 000 €** à part selon les coups de cœur. Seiko au Japon = souvent 20-30 % moins cher qu'en Belgique + détaxe 10 % en boutique tourist.

---

## 🎟️ Checklist réservations (à faire AVANT le départ)
...
| 🚄 **Shinkansen** (Mishima→Kyoto, Osaka→Tokyo) | 1 mois avant (sièges réservés) | JR West / SmartEX | 🟡 |
...
| Élément | Détail |
|:---|:---|
| 🛂 **Visit Japan Web** | QR code immigration + douane — à remplir **avant le vol** (évite les files) |
| 📱 **Welcome Suica** | Carte IC rechargeable pour transports + konbini — à l'aéroport |
| 📶 **eSIM / Pocket WiFi** | Internet partout — commander avant le départ |
| ♿ **Accessibilité** | Demander les hôtels avec **ascenseur direct** et chambres au **niveau bas** (pas d'escalier) |
| 🪑 **USJ fauteuil roulant** | Gratuit sur place (location à l'entrée) — anticiper pour J17 |
| 🍽️ **Tabelog** | L'appli resto japonaise (l'équivalent du Guide Michelin local) |
| 🧮 **JR Pass Calculator** | Vérifier si le JR Pass vaut le coup pour ce trajet |
| 💱 **Détaxe** | 10 % de remise en boutique tourist sur achats > 5 000 JPY (passeport requis) |
| 🔌 **Adaptateur** | Prises type A (2 broches plates), 100 V |
| 🏥 **Assurance voyage** | Carte européenne + complémentaire rapatriement — **vérifier la couverture santé de Sylvie** |

---

## 📝 Notes & Astuces

### 🚶 Rythme adapté à Sylvie (5-6 km/j max)
- **3 journées off** intégrées (J12 Kyoto, J16 Osaka) + **repos matin** sur 4 autres jours (J4, J8, J10, J15, J19)
- **Total ~3 km/jour de moyenne** — large marge sous la limite de 5-6 km
- **Escaliers à éviter** : Fushimi Inari → **bas seulement** (l'allée des torii monte fort). Kiyomizu → entrée par le bas.
- **Si fatigue en cours de journée** : taxi (abondants et propres au Japon, ~10-15 € les trajets courts) — budgeter ~100 € de taxis de secours
- **Onsen tous les 2-3 jours** pour la récupération musculaire ♨️

### 🗺️ Randonnées supprimées (comparées au document initial)
- ❌ **Rando Kurama → Kibune** (5-6 km de montée raide) → remplacée par Gion/Nishiki balade
- ❌ **Ascension Fuji** → remplacée par **Hakone** (téléphérique + bateau, zéro effort) + **pagode Chureito** (vue bus + courte marche plate)
...
- « Rando Mont Hushiwari » → **supprimée** (montée trop raide) → remplacée par Hakone + Chureito vue
- « Kira kamakura » → **Kita-Kamakura** (l'arrêt AVANT Kamakura)
- « Kinkaku-ju » → **Kinkaku-ji** (le Pavillon d'Or)
- J6 du PDF (rando + trajet) → **devenu J6-Hakone** (journée détente totale)

### 💡 Bonus si le budget le permet
- **Taxi de secours** : ~100 € prévus pour les jours de fatigue
- **Kobe** (journée depuis Osaka) : uniquement si grosse motivation — sinon Minoo (calme)
