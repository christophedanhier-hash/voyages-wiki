...
| **Réservations** | ✅ **Tous les campings sont réservés** pour les 2 CC (David & Nancy dans les mêmes campings à partir de Venise). ✅ **Europa Village entièrement payé le 25/08/2026** (acompte 65,76 € + solde 153,44 €). Taxe de séjour 3,60 € à régler sur place. ✅ **Confirmations d'arrivée reçues le 25/08/2026** (Spartacus, Atlantide, Led Zeppelin). ⚠️ **hu Firenze : piazzola max 7 m — CC 8 m non adapté, upgrade Premium +310 € à décider** (voir section réservations) |
...
| Florence | **hu Firenze camping in town** | ⚠️ #314185774 — piazzola max 7 m, upgrade Premium **+310 €** ? | 3 nuits | 165,00 € | ❌ Carte garantie |
...
| **hu Firenze camping in town** | Emplacement 50-60m². ⚠️ **Piazzola hu camp Easy : max 7 m — CC 8 m NON adapté** (mail hu openair du 25/08/2026). Option : upgrade **hu camp Premium +310,00 €** (eau + électricité exclusifs) — **⏳ DÉCISION REQUISE**. Love Pet Pack 15€. Check-in 24h/24. Adresse: Via della Chiesa 1/3, 50136 Firenze |
...
| Poste | Coût |
|-------|:----:|
| 🏕️ Campings | ~1 431,80 € ⚠️ *(+310 € si upgrade hu Firenze Premium — décision en attente)* |
...
- **hu Firenze camping in town** : Via della Chiesa 1/3, 50136 Florence. Grands emplacements 50-60m². Love Pet Pack 15€. Check-in 24h/24. Tram T1 depuis/vers le centre. ⚠️ **ATTENTION (25/08/2026)** : la piazzola hu camp Easy réservée ne convient PAS au CC de 8 m (max 7 m). hu openair propose un **upgrade hu camp Premium à +310,00 €** (eau + électricité exclusifs). **Décision à prendre ⏳** — soit accepter l'upgrade, soit trouver un autre camping à Florence pour les 3 nuits (14→17/09)
