...
## 🚗 Logistique Enyaq 60 (électrique)

| Point | Détail |
|:---|:---|
| **Distance** | ~310-330 km (Sombreffe → Paris, via autoroute) |
| **Autonomie hiver** | ~290 km (batterie 58 kWh, conso ~20 kWh/100km avec chauffage) |
| **⚠️ Recharge aller** | **Nécessaire** — prévoir 1 arrêt ~15-20 min (10→80 %) |
| **Recharge retour** | Idem — 1 arrêt sur le chemin |
| **Bornes rapides** | Réseaux Ionity / Fastned / TotalEnergies sur l'autoroute (100-135 kW) |
| **⚠️ Charge au retour** | Recharger à Paris avant le départ (hôtel avec borne ou borne publique) |
| **Appli** | Chargemap / ABRP (A Better Route Planner) pour planifier |

> 💡 **Arrêt recommandé aller** : aire de service sur l'A4 ou l'A1 (~mi-chemin, Reims ou Compiègne) — vérifier la présence de bornes ≥100 kW.
> 💡 **À l'hôtel** : chercher un hôtel avec **borne de recharge** ou un parking public avec bornes à proximité.
...
## 🚕 Trajets Camille — Adagio Kléber → Palais des Congrès

| Point | Détail |
|:---|:---|
| **Départ** | Adagio La Défense Kléber — 73 av. Gambetta, 92400 Courbevoie |
| **Arrivée** | Palais des Congrès — 2 pl. Porte-Maillot, 75017 |
| **Distance** | ~3 km (route) / ~2,2 km à pied |
| **Fréquence** | 4 trajets/jour pendant le congrès (mar→sam) |

### Les 4 options

| Option | Durée | Coût | ⭐ Fiabilité | Verdict |
|:---|:---:|:---:|:---:|:---|
| 🚇 **Métro ligne 1** | ~25 min (marche 12 min + 1 station + 5 min) | **2,50 €** | ⭐⭐⭐⭐⭐ | **Le plus fiable** — 1 seule station (Esplanade de La Défense → Porte Maillot), ligne automatique, jamais bloquée par le trafic |
| 🚕 **Uber / taxi** | 8-15 min (trafic) | **12-18 €** | ⭐⭐ (bouchons matin/soir) | Porte-à-porte, mais la semaine ADF = trafic dense autour de Porte Maillot |
| 🚌 **Bus 174 / 274** | ~25-35 min | **2,50 €** | ⭐⭐⭐ | Direct Courbevoie → Porte Maillot, mais dépend du trafic |
| 🚶 **À pied** | 28-30 min | Gratuit | ⭐⭐⭐⭐ | Faisable mais long en talons + chaque jour |

### 🎯 Plan recommandé pour Camille

| Moment | Transport | Pourquoi |
|:---|:---|:---|
| **Matin (8h00-8h30)** | 🚇 **Métro ligne 1** | Trafic dense → le métro est sûr, 25 min chrono, 2,50 € |
| **Soir (retour ~18h)** | 🚕 **Uber** ou métro | Si fatigue/courses → Uber porte-à-porte 12-18 € ; sinon métro |

> 💡 **Itinéraire métro précis** : Adagio Kléber → marche 12 min → **Esplanade de La Défense** (ligne 1, direction Château de Vincennes) → 1 station → **Porte Maillot** → sortie 3 (Palais des Congrès). Simple et direct !
>
> 💡 **Ticket** : acheter un carnet de 10 tickets t+ (~19 €) ou utiliser le pass Navigo Easy. 8 trajets aller-retour sur 4 jours = ~20 € en carnet.
...
> 🚕 **Transport** : **Uber / VTC avec poussette** pour les visites (choix Papy/Mamy) — porte-à-porte depuis l'Adagio Kléber, ~15-25 € selon distance. Uber XL si besoin de place pour la poussette.

| Jour | Visite | Quartier | Depuis Adagio Kléber | Notes bébé 👶 |
|:---:|:---|:---|:---|:---|
| J2 (mer 25/11) | **Panthéon** ⛪ | 5e (Luxembourg) | Uber ~25 min / 20-25 € | Intérieur chauffé, poussette OK |
| J3 (jeu 26/11) | **Notre-Dame** 🕍 | 4e (Île de la Cité) | Uber ~30 min / 25-30 € | Extérieur + parvis, chantier — vérifier accès |
| J4 (ven 27/11) | **Invalides** 🎖️ | 7e | Uber ~25 min / 20-25 € | Musée de l'Armée, esplanade, tombeau de Napoléon |
| + selon temps | **Arc de Triomphe** 🏛️ | 8e (Étoile) | Uber ~15 min / 15-20 € | Vue depuis le rond-point (pas les 284 marches 😅) |

### Samedi 28/11 — Journée à 5 visites (avec Jérémy, Camille libérée à 12h)

> 🚶 **Boucle « Axe historique »** — visites à distance de marche les unes des autres (ou mini-Uber entre étapes). Départ ~13h après le déjeuner.

| # | Visite | Quartier | Entre les étapes | Note |
|:---:|:---|:---|:---|:---|
| 1 | 🖼️ **Louvre** 🎨 | 1er (Palais Royal) | — | **Créneau à réserver en ligne** — entrée Carrousel accessible, poussettes OK, espaces bébé |
| 2 | 🌳 **Jardin des Tuileries** | 1er | 5 min à pied | Balade poussette, manèges, goûter possible |
| 3 | 🏛️ **Place de la Concorde / Obélisque** | 8e | 10 min à pied | Grande place, vue sur les Champs-Élysées |
| 4 | 🛍️ **Champs-Élysées** | 8e | 15 min à pied | Vitrines de Noël 🎄 (fin novembre = illuminations !), pause café |
| 5 | 🏛️ **Arc de Triomphe** | 8e (Étoile) | 20 min à pied | Fin de journée, coucher de soleil + montée possible (Camille & Jérémy) |

> 💡 **Rythme senior + bébé** : les 5 visites se font en boucle douce sur l'axe Louvre → Étoile (~4 km au total, pauses aux étapes 2 et 4). Si fatigue : Uber entre les étapes 3→4→5.
> 💡 **Louvre** : réservation créneau horaire conseillée (gratuit pour les moins de 18 ans, ~22 € adultes).
> 💡 **Arc de Triomphe** : montée 284 marches (ascenseur partiel) — Papy/Mamy peuvent admirer depuis le rond-point pendant que Camille & Jérémy montent.

---

## 👶 Bébé Célestine (7-8 mois) — checklist
...
| Ven (Le Compositeur, **5 pers** — 4 adultes + bébé 🎉) | ~190 € |
| Sam (Monsieur Maillot, **5 pers** — 4 adultes + bébé 🎉) | ~180 € |
| **Total restaurants (5 soirs)** | **~580 €** |
